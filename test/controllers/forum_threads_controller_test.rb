...
class ForumThreadsControllerTest < ActionController::TestCase
  ...
  test "should create forum_thread" do
    assert_difference('ForumThread.count') do
      post :create, forum_thread: { last_page_scraped: @forum_thread.last_page_scraped, link: @forum_thread.link, name: @forum_thread.name }
    end
  ...
  test "should update forum_thread" do
    patch :update, id: @forum_thread, forum_thread: { last_page_scraped: @forum_thread.last_page_scraped, link: @forum_thread.link, name: @forum_thread.name }
    assert_redirected_to forum_thread_path(assigns(:forum_thread))
  end
